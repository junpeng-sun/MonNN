...
def cross_validate(
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(X, y)):
        ...
        train_ds = build_tensor_dataset(X_train[fit_idx], y_train[fit_idx], task_type)
        stop_ds = build_tensor_dataset(X_train[stop_idx], y_train[stop_idx], task_type)
        ...
        stop_loader = DataLoader(stop_ds, batch_size=best_config["batch_size"])
        ...
        random_sample = sample_random_in_domain(
...
def main():
    ...
    results_file = experiment_result_file(__file__, "main", "exps_LMN.csv")
