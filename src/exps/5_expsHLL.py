...
def create_model(
    ...
    return HLLNetwork(
        ...
        activation=nn.ReLU(),
        # HLL's auxiliary network must produce non-negative interpolation
        # weights; the official custom-auxiliary example uses a sigmoid output.
...
def main():
    ...
    results_file = experiment_result_file(__file__, "main", "exps_HLL.csv")
