...
class MonoNet(nn.Module):
    ...
    def __init__(self, num_features: int, num_classes: int,
                 ...
                 interpretable_size: int = 8,
                 monotonic_sizes: Optional[List[int]] = None,
        ...
        hidden_sizes = [16, 16] if hidden_sizes is None else list(hidden_sizes)
        monotonic_sizes = [32] if monotonic_sizes is None else list(monotonic_sizes)
